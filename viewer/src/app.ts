...
const sidebarUI = new SidebarUI(document, window, 250, [
  "sidebar-search",
  "sidebar-visibility"
]);
...
const ui = new UI(
  document,
  new SettingsUI(document),
  sidebarUI,
  new SearchUI(document, sidebarUI),
  new VisibilityUI(document, sidebarUI),
  bottombarUI,
  new DetailsUI(document, bottombarUI),
